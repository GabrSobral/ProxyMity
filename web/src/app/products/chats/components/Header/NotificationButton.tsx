...
export function NotificationButton() {
	return (
		<Popover className="relative z-20">
			<Popover.Button title="" className="rounded-full p-2 hover:bg-purple-500 transition-colors">
					...
					<ul className="w-full flex-col flex gap-1">
						<li className="flex w-fit items-center gap-4 hover:bg-purple-500 p-2 rounded-[calc(1rem-0.5rem)] overflow-hidden max-w-[400px] cursor-pointer transition-all">
							...
							<div className="flex flex-col gap-2 overflow-hidden">
								<span className="text-white whitespace-nowrap truncate text-sm">
									You have a new message!
								</span>

								<span className="text-white opacity-75 whitespace-nowrap truncate text-sm">
									Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsam optio nihil
									doloremque molestiae consectetur non id corporis voluptas, dolores, accusantium
									officiis assumenda delectus quae tempora porro. Laborum quisquam dignissimos
									saepe.
								</span>
							</div>
						</li>
