<script lang="ts">
	...
	import PhoneCall from 'phosphor-svelte/lib/PhoneCall';
	import VideoCamera from 'phosphor-svelte/lib/VideoCamera';
	import SpeakerSimpleSlash from 'phosphor-svelte/lib/SpeakerSimpleSlash';
...
<header class="rounded-[10px] p-3 bg-purple-400 flex flex-col gap-3">
	...
	<div class="flex gap-3">
		...
		>
			<PhoneCall class="text-white" size={28} weight="light" />
		</button>
		...
		>
			<VideoCamera class="text-white" size={28} weight="light" />
		</button>
		...
		>
			<PushPin class="text-white" size={28} weight="light" />
		</button>
		...
		>
			<SpeakerSimpleSlash class="text-white" size={28} weight="light" />
		</button>
	</div>
