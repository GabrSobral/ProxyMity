...
<Dialog let:Description let:Title show={isVisible} closeModal={closeModal} className="gap-3 max-w-[36rem]">
    ...
    <Description>
        Protect yourself by choosing a strong password.
    </Description>
    ...
    <div class="dark:bg-gray-950 bg-gray-100 p-2 px-4 rounded-[10px] flex items-center justify-between mt-4 shadow-inner">
