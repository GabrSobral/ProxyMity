...
<main class="flex-1 flex items-center justify-center bg-[url('/sign-background.svg')] bg-no-repeat bg-cover relative">
    ...
    <div class="p-4 duration-300 rounded-[1rem] ring-1 ring-gray-700 w-96 flex flex-col gap-4 shadow-lg bg-gray-800/40 backdrop-blur-sm transition-all max-h-full">
        ...
        <div class="flex w-full bg-gray-900 relative rounded-full shadow-inner">
            <div
