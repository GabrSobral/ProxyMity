...
{#if participantsTyping.length}
   <div
      class="absolute z-[20] bottom-[3.5rem] py-1 mx-1 mb-1 px-4 items-center flex gap-2 bg-gray-900 rounded-lg w-fit"
      transition:fly={{ y: 40, opacity: 0 }}
   >
      <div class="flex">
         {#each participantsTyping as participantTyping}
