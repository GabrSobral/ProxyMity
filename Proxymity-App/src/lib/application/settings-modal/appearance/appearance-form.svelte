<script lang="ts">
   ...
   import DarkPlaceholder from './components/dark-placeholder.svelte';
   import LightPlaceholder from './components/light-placeholder.svelte';
   import SystemPlaceholder from './components/system-placeholder.svelte';
